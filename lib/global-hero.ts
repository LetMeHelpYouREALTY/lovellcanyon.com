...
export const GLOBAL_HERO: GlobalHeroConfig = {
  src: "/images/global-hero/lovell-canyon.jpg",
  alt: "Desert canyon and sandstone cliffs near Lovell Canyon, Las Vegas, NV",
  tagline: "Lovell Canyon Homes by Dr. Jan Duffy",
