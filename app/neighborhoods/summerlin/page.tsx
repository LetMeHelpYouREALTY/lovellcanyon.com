...
export const metadata: Metadata = {
  ...
  description:
    "Find Summerlin homes with Berkshire Hathaway HomeServices Nevada Properties. Dr. Jan Duffy offers expert guidance in Las Vegas's premier master-planned community. Median price $625K. Call (702) 842-9736.",
  keywords: [
