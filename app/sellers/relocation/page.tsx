...
export const metadata: Metadata = {
  ...
  description:
    "Leaving Las Vegas for a new opportunity? Dr. Jan Duffy helps relocating homeowners sell fast and coordinates with BHHS offices nationwide. Call (702) 842-9736.",
  keywords: [
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-4xl mx-auto text-center mb-16">
            ...
            >
              ...
              Start Your Relocation → (702) 842-9736
            </a>
          </div>
