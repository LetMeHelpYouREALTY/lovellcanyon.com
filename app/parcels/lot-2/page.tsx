...
export default async function Lot2Page() {
  if (!parcel) notFound();
  ...
  const relatedPages = [
    { href: "/parcels/lot-3", label: "Lot 3", desc: "Adjacent parcel APN 135-31-801-007" },
    ...
    { href: "/contact", label: "Contact", desc: "Inquire about Lot 2" },
  ];
  ...
  return (
    <>
      ...
      />
      <Navbar />
      <LandBreadcrumbs items={LOVELL_CANYON_BREADCRUMBS.lot2} />
      <main>
        <LandPageHeroSection
          pathname={pathname}
          badge="Lot 2"
